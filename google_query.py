...
class pygoogle:
    ...
    def __init__(self,query,pages=1,hl='en',log_level=logging.INFO):
    ...
    def search_page_wise(self):
        ...
        for page in range(0,self.pages):
            ...
            data = json.loads(search_results.read().decode("utf-8"))
            urls = []
            if 'responseData' in data and 'results' in data['responseData'].keys():
                for result in  data['responseData']['results']:
    ...
    def get_result_count(self):
        ...
        try:
            ...
            if result_count:
                if 'cursor' in result_count.keys() and 'estimatedResultCount' in result_count['cursor']:
